...
update tbConta set Saldo = Saldo + Saldo/10 where numeroConta = "9876";
-- Saldo = Saldo * 1.1 
...
select * from tbConta;
/* Não podemos apagar uma chave estrangeira, pois elas realizam a conexão entre tabelas e registros.
 A menos que tenha uma prova concreta de que os atributos estão incorretos. */
